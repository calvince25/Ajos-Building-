...
export default function MasonryBuildingMaterials() {
  const faqs = [
    {
    ...
    <main className="bg-background">
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 bg-primary overflow-hidden">
        <div className="absolute inset-0">
          <img loading="lazy" src="https://images.unsplash.com/photo-1565372195458-9de0b320ef04?w=1600&h=800&fit=crop&auto=format" alt="Skilled mason laying precision concrete blocks for a structural wall" className="w-full h-full object-cover opacity-25" />
      ...
      <section className="py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <img loading="lazy" src="https://images.unsplash.com/photo-1621905252507-b35492cc74b4?w=800&h=1000&fit=crop&auto=format" alt="Masons constructing a precision stone boundary wall" className="rounded-2xl shadow-2xl object-cover w-full h-[580px]" />
